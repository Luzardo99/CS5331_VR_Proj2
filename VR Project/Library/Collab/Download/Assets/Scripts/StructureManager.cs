...
{
    public StructurePrefabWeighted[] housesPrefabe, specialPrefabs, BankPrefabs;
    public PlacementManager placementManager;

    private float[] houseWeights, specialWeights, bankWeights;
    ...
    public void PlaceBank(Vector3Int position)
    {
        if (CheckPositionBeforePlacement(position))
        {
            int randomIndex = GetRandomWeightedIndex(bankWeights);
